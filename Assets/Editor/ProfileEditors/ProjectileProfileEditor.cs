    ...
    public class ProjectileProfileEditor : EditorWindow
    {
        ...
        void OnGUI()
        {
            ...
            GUILayout.BeginHorizontal();
            {
                ...
                {
                    CommonEditorUtility.DrawData(_save.ProjectileProfiles, ref _currentProfile);
                    CommonEditorUtility.DrawAddData(_save.ProjectileProfiles, ref _currentProfile);
                    CommonEditorUtility.DrawRemoveData(_save.ProjectileProfiles, ref _currentProfile);
