...
public class UserRecordEditor : EditorWindow
{
    ...
    void OnGUI()
    {
        ...
        GUILayout.BeginHorizontal();
        {
            ...
            {
                bool isChagned = CommonEditorUnitity.DrawData(_save.UserRecords, ref _currentRecord);
                CommonEditorUnitity.DrawAddData(_save.UserRecords, ref _currentRecord);
                CommonEditorUnitity.DrawRemoveData(_save.UserRecords, ref _currentRecord);
            ...
            GUILayout.BeginVertical();
            {
                ...
                GUILayout.BeginHorizontal();
                {
                    GUILayout.BeginVertical(GUILayout.Width(150));
                    {
                        ...
                        {
                            CommonEditorUnitity.DrawData(_currentRecord.ActorRecords, ref _currentActorRecord);
                        } GUILayout.EndScrollView();
                        CommonEditorUnitity.DrawAddData(_currentRecord.ActorRecords, ref _currentActorRecord);
                        CommonEditorUnitity.DrawRemoveData(_currentRecord.ActorRecords, ref _currentActorRecord);
                    } GUILayout.EndVertical();
